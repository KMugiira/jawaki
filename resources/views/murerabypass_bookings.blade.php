...
<head>
    ...
    <link rel='shortlink' href='http://jawakiproperty.com/?p=786' />
    <link rel="alternate" type="application/json+oembed" href="http://jawakiproperty.com/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fjawakiproperty.com%2Fhome%2Flogin%2Fproperty%2Fmurera-magomano-bookings%2F" />
    <link rel="alternate" type="text/xml+oembed" href="http://jawakiproperty.com/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fjawakiproperty.com%2Fhome%2Flogin%2Fproperty%2Fmurera-magomano-bookings%2F&#038;format=xml" />
    <script type="text/javascript">
        (function(url){
        ...
        })('//jawakiproperty.com/?wordfence_lh=1&hid=1C6B641F6EEC23B2C9A4570B8DC90A21');
    </script>    <script type="text/javascript">var ajaxurl = 'http://jawakiproperty.com/wp-admin/admin-ajax.php';</script>
</head>

<body class="page-template-default page page-id-786 page-parent page-child parent-pageid-53">
                ...
                <div id="secondary" class="widget-area col-md-3" role="complementary">
                    <aside id="theme-my-login-2" class="widget widget_theme_my_login"><h3 class="widget-title">Log In</h3>
                        <div class="tml tml-login" id="theme-my-login1">
                            <form name="loginform" id="loginform1" action="/home/login/property/murera-magomano-bookings/?instance=1" method="post">
                                ...
                                <input type="hidden" name="_wp_original_http_referer" value="/home/login/property/murera-magomano-bookings/" />
...
<!-- Cached page generated by WP-Super-Cache on 2018-04-23 16:29:55 -->
