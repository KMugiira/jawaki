...
-->
    ...
    <head>
        <title>Photocall a Photogallery Category Bootstrap Responsive Web Template | Home :: w3layouts</title>
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
                    ...
                    <ul class="rslides" id="slider4">
                        <li>
                            <div class="respon_info_img">
                                <img src="{{asset('asset/images/banner3.jpg')}}" class="img-responsive" alt="PhotoCall">
                            </div>
                        ...
                        <li>
                            <div class="respon_info_img">
                                <img src="{{asset('asset/images/banner2.jpg')}}" class="img-responsive" alt="PhotoCall">
                            </div>
                            <div class="banner_bottom_left">
                        ...
                        <li>
                            <div class="respon_info_img">
                                <img src="{{asset('asset/images/banner1.jpg')}}" class="img-responsive" alt="PhotoCall">
                            </div>
                            <div class="banner_bottom_left">
                        ...
                        <li>
                            <div class="respon_info_img">
                                <img src="{{asset('asset/images/banner4.jpg')}}" class="img-responsive" alt="PhotoCall">
                            </div>
                            <div class="banner_bottom_left">
                ...
                <div class="col-md-6 banner_bottom_left">
                    <div class="banner_bottom_pos">
                        <div class="banner_bottom_pos_grid">
                            ...
                            <div class="col-xs-9 banner_bottom_grid_right">
                                <h4>Be The Best Photographer</h4>
                                <p>Lorem Ipsum is simply text the printing and typesetting standard industry.</p>
                                <div class="barWrapper">
    ...
    <div class="banner_bottom" id="team">
        <div class="container">
            <h3 class="tittle_w3ls">Meet the Team</h3>
            <div class="inner_sec_info_agile_w3_info">
                <div class="ser-first">
        ...
        <div class="col-md-4 col-sm-4 col-xs-4 gal-sec">
            <div class="gallery-grid1">
                <a title="100% Satisfaction." href="images/gal1.jpg">
                    <img src="{{asset('asset/images/gal1.jpg')}}" alt=" " class="img-responsive" />
                    <div class="p-mask">
                        <h4>tittle_w3ls Here</h4>
                        <p>Description</p>
                    </div>
                </a>
            </div>
            <div class="gallery-grid1">
                <a title="100% Satisfaction." href="images/gal2.jpg">
                    <img src="{{asset('asset/images/gal2.jpg')}}" alt=" " class="img-responsive" />
                    <div class="p-mask">
                        <h4>tittle_w3ls Here</h4>
                        <p>Description</p>
                    </div>
            ...
            <div class="gallery-grid1">
                <a title="100% Satisfaction." href="images/gal4.jpg">
                    <img src="{{asset('asset/images/gal4.jpg')}}" alt=" " class="img-responsive" />
                    <div class="p-mask">
                        <h4>tittle_w3ls Here</h4>
                        <p>Description</p>
                    </div>
        ...
        <div class="col-md-4 col-sm-4 col-xs-4 gal-sec">
            <div class="gallery-grid1">
                <a title="100% Satisfaction." href="images/gal31.jpg">
                    <img src="{{asset('asset/images/gal3.jpg')}}" alt=" " class="img-responsive" />
                    <div class="p-mask">
                        <h4>tittle_w3ls Here</h4>
                        <p>Description</p>
                    </div>
            ...
            <div class="gallery-grid1">
                <a title="100% Satisfaction." href="images/gal5.jpg">
                    <img src="{{asset('asset/images/gal5.jpg')}}" alt=" " class="img-responsive" />
                    <div class="p-mask">
                        <h4>tittle_w3ls Here</h4>
                        <p>Description</p>
                    </div>
        ...
        <div class="col-md-4 col-sm-4 col-xs-4 gal-sec">
            <div class="gallery-grid1">
                <a title="100% Satisfaction." href="images/gal6.jpg">
                    <img src="{{asset('asset/images/gal6.jpg')}}" alt=" " class="img-responsive" />
                    <div class="p-mask">
                        <h4>tittle_w3ls Here</h4>
                        <p>Description</p>
                    </div>
            ...
            <div class="gallery-grid1">
                <a title="100% Satisfaction." href="images/gal71.jpg">
                    <img src="{{asset('asset/images/gal7.jpg')}}" alt=" " class="img-responsive" />
                    <div class="p-mask">
                        <h4>tittle_w3ls Here</h4>
                        <p>Description</p>
                    </div>
        ...
        <div class="col-md-3 col-sm-3 col-xs-3 gal-sec">
            <div class="gallery-grid1">
                <a title="100% Satisfaction." href="images/gal81.jpg">
                    <img src="{{asset('asset/images/gal8.jpg')}}" alt=" " class="img-responsive" />
                    <div class="p-mask">
                        <h4>tittle_w3ls Here</h4>
                        <p>Description</p>
                    </div>
        ...
        <div class="col-md-6 col-sm-6 col-xs-6 gal-sec">
            <div class="gallery-grid1">
                <a title="100% Satisfaction." href="images/gal9.jpg">
                    <img src="{{asset('asset/images/gal9.jpg')}}" alt=" " class="img-responsive" />
                    <div class="p-mask">
                        <h4>tittle_w3ls Here</h4>
                        <p>Description</p>
                    </div>
        ...
        <div class="col-md-3 col-sm-3 col-xs-3 gal-sec">
            <div class="gallery-grid1">
                <a title="100% Satisfaction." href="images/gal101.jpg">
                    <img src="{{asset('asset/images/gal10.jpg')}}" alt=" " class="img-responsive" />
                    <div class="p-mask">
                        <h4>tittle_w3ls Here</h4>
                        <p>Description</p>
                    </div>
    ...
    <div class="banner_bottom">
        <div class="container">
            <h3 class="tittle_w3ls">All in one Platform
            </h3>
            <div class="inner_sec_info_agile_w3_info">
                <div class="last_sec">
    ...
    <div class="price-sec" id="price">
        <div class="container">
            <h3 class="tittle_w3ls">Simple Pricing</h3>
                                    ...
                                    <blockquote>
                                        <div class="test_grid">
                                            ...
                                            <div class="col-sm-9 test_img_info">
                                                <p><i class="fas fa-quote-left"></i> Maecenas quis neque libero. Class aptent taciti.Lorem ipsum dolor sit amet,
                                                    consectetur adipiscing elit. Etiam auctor nec lacus ut tempor. Mauris.</p>
                                                <h6>Sara Lisbon</h6>
                                            </div>
                                        </div>
                                    </blockquote>
                                ...
                                <div class="item">
                                    <blockquote>
                                        <div class="test_grid">
                                            ...
                                            <div class="col-sm-9 test_img_info">
                                                <p><i class="fas fa-quote-left"></i> Lorem ipsum dolor sit amet. Class aptent taciti.Lorem ipsum dolor sit amet,
                                                    consectetur adipiscing elit. Etiam auctor nec lacus ut tempor. Mauris.</p>
                                                <h6>Jane Wearne</h6>
                                            </div>
                                        </div>
    ...
    <script type="text/javascript" src="{{asset('asset/js/all.js')}}"></script>
    <script>
    ...
    <!--gallery -->
    <script src="{{asset('asset/js/jquery.chocolat.js')}}"></script>
    <!--light-box-files -->
    ...
    <script type="text/javascript" src="{{asset('assetjs/move-top.js')}}"></script>
    <script type="text/javascript">
