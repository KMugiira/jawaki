                            ...
                            <div class="row">
                                ...
                                <div id="post-459" class="col-sm-12 col-md-12 post-459 rem_property type-rem_property status-publish has-post-thumbnail hentry">
                                    ...
                                    <div class="section-title line-style">
                                        <h3 class="title">Ndarasha</h3>
                                    </div>
                                    <div class="description">
                                        <p>40 by 60 plots with ready title deeds.</p>
                                        <p>The plots are near Ndarasha shopping centre where government e.g schools,hospitals and  police post are located.</p>
                                        <p>The area is quite developed and well populated.</p>
                                                            ...
                                                            <div class="ptsEl ptsCol ptsElWithArea ptsCol-1" data-el="table_col" style="height: auto; width: 25%;">
                                                                <div class="ptsTableElementContent ptsElArea">
                                                                    ...
                                                                    <div class="ptsColDesc ptsToggle" style="height: 86px;">
                                                                        <div class="ptsEl" data-el="table_cell_txt" data-type="txt" style=""><p><span data-mce-style="">Ndarasha 1 - 200,000/=&nbsp;</span></p></div>
                                                                    </div>
                                                                    ...
                                                                    <div class="ptsColFooter" style="height: 169px;">
                                                                        <div class="ptsActBtnWp">
                                                                            <div class="ptsActBtn ptsEl ptsElInput" data-el="btn" data-bgcolor="rgba(2,138,105,1)" data-bgcolor-elements="a" data-bgcolor-to="bg">
                                                                                <a href="{{url('ndarasha_bookings')}}" class="ptsEditArea ptsInputShell" style="font-size: 12px; background-color: rgb(2, 138, 105);">VIEW</a>
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <div class="ptsColsWrapper ui-sortable">
                                                            ...
                                                            <div class="ptsEl ptsCol ptsElWithArea ptsCol-1" data-el="table_col" style="height: auto; width: 25%;">
                                                                <div class="ptsTableElementContent ptsElArea">
                                                                    ...
                                                                    <div class="ptsColDesc ptsToggle" style="height: 86px;">
                                                                        <div class="ptsEl" data-el="table_cell_txt" data-type="txt" style=""><p><span data-mce-style="">Ndarasha 5 - 200,000/=&nbsp;</span></p></div>
                                                                    </div>
                                                                    <div class="ptsRows ui-sortable" style="height: auto;">
                                                            ...
                                                            <div class="ptsEl ptsCol ptsElWithArea ptsCol-2" data-el="table_col" style="height: auto; width: 25%;">
                                                                <div class="ptsTableElementContent ptsElArea">
                                                                    ...
                                                                    <div class="ptsColDesc ptsToggle" style="height: 86px;">
                                                                        <div class="ptsEl" data-el="table_cell_txt" data-type="txt" style=""><p><span data-mce-style="">Ndarasha 6 - 200,000/=&nbsp;</span></p></div>
                                                                    </div>
                                                                    <div class="ptsRows ui-sortable" style="height: auto;">
                                                            ...
                                                            <div class="ptsEl ptsCol ptsElWithArea ptsCol-3" data-el="table_col" style="height: auto; width: 25%;">
                                                                <div class="ptsTableElementContent ptsElArea">
                                                                    ...
                                                                    <div class="ptsColDesc ptsToggle" style="height: 86px;">
                                                                        <div class="ptsEl" data-el="table_cell_txt" data-type="txt" style=""><p><span data-mce-style="">Ndarasha 7 - 200,000/=</span></p></div>
                                                                    </div>
                                                                    <div class="ptsRows ui-sortable" style="height: auto;">
                                                                    ...
                                                                    <div class="ptsColFooter" style="height: 156px;">
                                                                        <div class="ptsActBtnWp">
                                                                            <div class="ptsActBtn ptsEl ptsElInput" data-el="btn" data-bgcolor="rgba(2,138,105,1)" data-bgcolor-elements="a" data-bgcolor-to="bg">
                                                                                <a href="{{url('Ndarasha-bookings')}}/" class="ptsEditArea ptsInputShell" style="font-size: 12px; background-color: rgb(2, 138, 105);">VIEW</a>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <div class="ptsEl ptsCol ptsElWithArea ptsCol-4" data-el="table_col" style="height: auto; width: 25%;">
                                                                <div class="ptsTableElementContent ptsElArea">
                                                                    ...
                                                                    <div class="ptsColDesc ptsToggle" style="height: 86px;">
                                                                        <div class="ptsEl" data-el="table_cell_txt" data-type="txt" style=""><p><span data-mce-style="">Ndarasha 8 - 200,000/=&nbsp;</span></p></div>
                                                                    </div>
                                                                    <div class="ptsRows ui-sortable" style="height: auto;">
                                    ...
                                    <div class="details">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4 col-xs-6">
                                                <div class="details no-padding">
                                                    <div class="detail" style="padding: 6px 15px;">
                                                        <strong>Address</strong> : Ndarasha                               </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-4 col-xs-6">
                                                <div class="details no-padding">
