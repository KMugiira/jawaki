...
<div id="page" class="hfeed site">
    ...
    <!--<div class="sydney-hero-area">
        ...
        <div id="slideshow" class="header-slider" data-speed="0" data-mobileslider="responsive">
            <div class="slides-container">
                ...
                <div class="slide-item slide-item-1" style="background-image:url('http://jawakiproperty.com/wp-content/uploads/2018/01/real-estate-e1516612768994.jpg');">
                    <img class="mobile-slide preserve" src="http://jawakiproperty.com/wp-content/uploads/2018/01/real-estate-e1516612768994.jpg" alt=""/>
                    <div class="slide-inner">
                        <div class="contain animated fadeInRightBig text-slider">
                            <h2 class="maintitle">Looking for a property?</h2>
                            <p class="subtitle">Find your dream property now!</p>
                        </div>
                        <a href="http://jawakiproperty.com/our-property/" class="roll-button button-slider">Get started now</a>                    </div>
                </div>
    ...
    <link rel="stylesheet" href="{{asset('asset/css/chocolat.css')}}" type="text/css" media="screen">
